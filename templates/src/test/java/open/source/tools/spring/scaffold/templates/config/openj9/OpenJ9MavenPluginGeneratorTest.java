...
import open.source.tools.spring.scaffold.templates.config.jms_aws_sqs.SQSDependencyGenerator;
...
public class OpenJ9MavenPluginGeneratorTest {
    ...
    public void shouldCreateFile() throws IOException, URISyntaxException {
        ...
        keyValue.put("${main_class}", "open.source.tools.spring.example.DemoApplication");
