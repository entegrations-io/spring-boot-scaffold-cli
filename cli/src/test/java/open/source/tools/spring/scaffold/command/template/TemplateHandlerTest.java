...
public class TemplateHandlerTest {
    ...
    public void shouldReturnOk() throws Exception {
        ...
        Mockito.when(scaffoldInfoHelper.getPackage()).thenReturn("open.source.tools.spring.example");
    ...
    public void givenOpenJ9_shouldReturnOk() throws Exception {
        ...
        Mockito.when(scaffoldInfoHelper.getPathPackage()).thenReturn("open.source.tools.spring.example");
        Mockito.when(scaffoldInfoHelper.getPathMainClass()).thenReturn("open.source.tools.spring.example.DemoApplication");
        Mockito.when(scaffoldInfoHelper.getPomPath()).thenReturn(getClass().getResource("/templates/template-fake-pom.xml").toURI().getPath());
        Mockito.when(scaffoldInfoHelper.getPomDest()).thenReturn(temporaryPath.getAbsolutePath().concat("/pom.xml"));
