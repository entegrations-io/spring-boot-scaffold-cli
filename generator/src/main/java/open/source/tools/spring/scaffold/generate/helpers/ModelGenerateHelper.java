...
//				new ModelGenerateHelper("java.lang.Object", "Object"),
	...
	public static String generateGettersAndSetters(String parameters) {
		...
		for (int i = 0; i < separator.length; i++) {
			...
			//SETTER
			gettersAndSetters += TAB + "public void set" + StringUtils.capitalize(name) + "(final " + type + " " + name + ") {\n";
			gettersAndSetters += TAB + TAB + "this." + name + " = " + name + ";\n";
			gettersAndSetters += TAB + "}\n";
			
			gettersAndSetters += "\n";
			
			//GETTER
			gettersAndSetters += TAB + "public " + type + " get" + StringUtils.capitalize(name) + "() {\n" ;
			gettersAndSetters += TAB + TAB + "return " + name + ";\n";
			gettersAndSetters += TAB + "}\n";
