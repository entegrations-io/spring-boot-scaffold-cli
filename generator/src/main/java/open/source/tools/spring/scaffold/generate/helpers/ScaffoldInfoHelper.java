...
import open.source.tools.spring.scaffold.generator.core.GeneratorExecutor;
import open.source.tools.spring.scaffold.generator.core.TemplateEngine;
...
public class ScaffoldInfoHelper {
    ...
    public boolean getSetupDone() {
        ...
        if (f.exists()) {
            ...
            System.out.println("Error: before scaffolding, execute spring setup:scaffold command");
            return false;
        }
    }
